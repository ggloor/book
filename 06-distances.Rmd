...
```{r R-block-bray, fig.height=14, fig.width=12, results="show", echo=FALSE, message=F, error=F, warnings=F, out.width="80%", fig.align ='center', fig.cap="Scatter plot of Bray-Curtis dissimilarities, or Jensen-Shannon divergence  of numerical vs. proportional and RLE normalized data."}
