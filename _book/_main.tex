...
It is worth pointing out that the RLE normalization (and the TMM and CSS normalizations) can substantially change our interpretation of the data. For example, the RLE normaliztion obliterates our ability to determine confidence intervals for our estimates.
...
\includegraphics{_main_files/figure-latex/yeast-lowvar-1.pdf}
\clearpage
