...
\addcontentsline{toc}{section}{Information and conventions}
...
{\centering \includegraphics[width=0.9\linewidth]{_main_files/figure-latex/shape-1} 
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/expected-1.pdf}
...
change in the last feature is 0. Taking the ratios, actually the
logarithm of the ratios is the key concept in compositional data
analysis, and further rationale is outlined in the following chapters.
...
{\centering \includegraphics[width=0.7\linewidth]{_main_files/figure-latex/R-disttest-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{_main_files/figure-latex/R-block-dist-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{_main_files/figure-latex/R-block-bray-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{_main_files/figure-latex/R-clr-plot-1} 
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/biplot-1.pdf}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/scatters-1.pdf}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/clrprop-1.pdf}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/group-1.pdf}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/yeast-biplot-1.pdf}
...
\begin{figure}
\centering
\includegraphics{_main_files/figure-latex/yeast-outlier-1.pdf}
...
\includegraphics{_main_files/figure-latex/yeast-good-data-pca-1.pdf}
...
\includegraphics{_main_files/figure-latex/yeast-lowvar-1.pdf} \clearpage
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(ppclust)}
\KeywordTok{library}\NormalTok{(factoextra)}
\KeywordTok{library}\NormalTok{(cluster)}
\KeywordTok{library}\NormalTok{(fclust)}


\NormalTok{res.fcm <-}\StringTok{ }\KeywordTok{fcm}\NormalTok{(d.lv.agg.n0.clr, }\DataTypeTok{centers=}\DecValTok{2}\NormalTok{)}
\CommentTok{#as.data.frame(res.fcm$u)}
\CommentTok{#summary(res.fcm)}

\NormalTok{res.fcm2 <-}\StringTok{ }\KeywordTok{ppclust2}\NormalTok{(res.fcm, }\StringTok{"kmeans"}\NormalTok{)}

\NormalTok{factoextra}\OperatorTok{::}\KeywordTok{fviz_cluster}\NormalTok{(res.fcm2, }\DataTypeTok{data =}\NormalTok{ d.lv.agg.n0.clr,}
  \DataTypeTok{ellipse.type =} \StringTok{"norm"}\NormalTok{, }\DataTypeTok{labelsize=}\DecValTok{10}\NormalTok{,  }\DataTypeTok{palette =} \StringTok{"jco"}\NormalTok{,}
  \DataTypeTok{repel =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{_main_files/figure-latex/yeast-fuzzy-1.pdf}
\#\#\#\#\#\#\#\#\#\#\#\#
